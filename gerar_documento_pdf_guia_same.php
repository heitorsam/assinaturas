           ...
           <!--TEXTO-->
            <div class='row '>
               <div class='col-hss-1' style='height: 720px; margin: 1px; '>
                   ...
                   <h1>Período de Internação: (informação obrigatória):  <b>".@$dados_result_resp_doc['PERIODO_MINIMO']." há ".@$dados_result_resp_doc['PERIODO_MAXIMO']."</b> </h1>
...
(CD_ATENDIMENTO, NM_PACIENTE, DT_ATENDIMENTO, 
 NM_CONVENIO, NOME_ANEXO, TP_DOCUMENTO, NM_USER, DT_CRIACAO, BLOB_ANEXO)
VALUES 
