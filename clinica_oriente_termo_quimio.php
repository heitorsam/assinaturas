            ...
            <div class="conteudo">
                ...
                <div class="container">
                    ...
                    function ajax_imprime_documento() {
                        ...
                        var var_atendimento = '<?php echo $var_atendimento; ?>';
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                ajax_insert_assinaturas_pac_med(var_assinatura_pac, var_assinatura_med, var_paciente, var_atendimento, var_prestador_logado);
                    ...
                    function ajax_insert_assinaturas_pac_med(var_assinatura_pac, var_assinatura_med, var_paciente, var_atendimento, var_prestador_logado){
                        ...
                        $.ajax({
                            url: "funcoes/termo_quimioterapia/ajax_guarda_assinaturas_pac_med.php",
                            type: "POST",
                            data: {
