...
<html>
    <body>
        ...
        <div class="div_br"> </div>
            <form method="post" autocomplete="off" action="check_gerar_documento_pdf.php">
                <div class="row">
                    <div class="col-md-3 ">
                        Data: 
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <div style="width:30px;"></div><button type="submit" class=" btn btn-primary" id="btn_pesquisar"> <i class="fas fa-plus"></i></button>	
